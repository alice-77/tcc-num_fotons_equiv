...
\definecolor{darkBlue}{HTML}{252E48}
\definecolor{darkGreen}{HTML}{0E3523}
\definecolor{darkRed}{HTML}{7D2827}
...
\begin{frame}
	...
	\column{0.5\textwidth}
		\begin{figure}
			\input{./figs/relativistic_ions-tikzgraph.tex}
...
\begin{frame}
	...
	\begin{figure}
		\begin{subfigure}[b]{0.4\textwidth}
			\centering
			\input{./figs/wave_pulses1-tikzgraph.tex}
			\caption{Campos observados no referencial do ponto $P$.}
		\end{subfigure}
		\hspace{1cm}
		\begin{subfigure}[b]{0.4\textwidth}
			\centering
			\input{./figs/wave_pulses2-tikzgraph.tex}
...
\begin{frame}
	...
	\begin{table}
		\input{./tables/tabela_fator_forma.tex}
...
\begin{frame}
	...
	\begin{figure}
		\begin{subfigure}[b]{0.45\textwidth}
			\centering
			\input{./figs/photoproduction1_fig.tex}
		...
		\begin{subfigure}[b]{0.45\textwidth}
			\centering
			\input{./figs/photoproduction2_fig.tex}
...
\begin{frame}
	\frametitle{Colisões Ultraperiféricas}
	\begin{table}
		\input{./tables/tab_colisores.tex}
...
\begin{frame}
	...
	{ \small
	\begin{table}
		\input{./tables/tabela_cronograma.tex}
